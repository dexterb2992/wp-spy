...
echo $generic->getOption('site-name'); }?></a>
		...
		<ul class="nav pull-right">
			<li class="dropdown">
				<p class="navbar-text dropdown-toggle" data-toggle="dropdown" id="userDrop"><?php echo $_SESSION['vd']['gravatar']; ?> <a href="#"><?php echo $_SESSION['vd']['username']; ?></a><b class="caret"></b></p>
				<ul class="dropdown-menu">
		<?php if(in_array(1, $_SESSION['vd']['user_level'])) { ?>
					...
					<li><a href="https://ymbproperties.uservoice.com/"><i class="icon-info-sign"></i> <?php _e('Help'); ?></a></li>
					<li class="divider"></li>
