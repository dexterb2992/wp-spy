			...
			<div class="control-group">
			  <div class="controls">
				<div class="input-prepend">
				  <button id="create_new_level_btn" class="btn"><?php _e('Create new level'); ?></button>
				  <input type="number" class="input-mini" min="0" id="showLevels" name="showLevels" placeholder="<?php _e('Show'); ?>" value="<?php echo !empty($_SESSION['vd']['levels_page_limit']) ? $_SESSION['vd']['levels_page_limit'] : 10; ?>">
				  <span class="add-on">
