...
class Profile extends Generic {
	...
	function __construct() {
		...
		if(!empty($_SESSION['vd']['forcePwUpdate']))
		...
		// Save the username
		$this->username = !empty($_SESSION['vd']['username']) ? $_SESSION['vd']['username'] : _('Guest');
	...
	private function determineGuest() {
		...
		if ( !empty($_SESSION['vd']['user_id']) && empty($_GET['uid']) )
			$this->user_id = $_SESSION['vd']['user_id'];
		...
		$this->guest = !( !empty($_SESSION['vd']['user_id']) && $_SESSION['vd']['user_id'] == $this->user_id );
	...
	private function updateEmailorPw() {
		...
		if(!empty($_SESSION['vd']['forcePwUpdate'])) unset($_SESSION['vd']['forcePwUpdate']);
