 ...
 * http://mgates.me/php-login-user-manage/install.php#/install-languages
 *
 * LICENSE:
 *
...
class Translate {
	...
	private function setLang() {
		...
		if ( !empty($_GET['lang']) ) :
			...
			if ( $this->displayName($lang) ) :
				$this->lang = $lang;
				$_SESSION['vd']['language'] = $lang;
			endif;

		endif;

		$this->lang = !empty($_SESSION['vd']['language']) ? $_SESSION['vd']['language'] : $this->lang;
	...
	public function languageSelector() {
		...
		foreach ( $options as $code => $language ) {
			...
			$selected = ( !empty($_SESSION['vd']['language']) && $_SESSION['vd']['language'] == $code ) ? 'selected="selected"' : '';
