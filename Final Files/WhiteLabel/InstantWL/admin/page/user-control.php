		...
		<div class="control-group">
		  <div class="controls">
			<div class="input-prepend">
			  ...
			  <input type="number" class="input-mini" min="0" id="showUsers" name="showUsers" placeholder="<?php _e('Show'); ?>" value="<?php echo !empty($_SESSION['vd']['users_page_limit']) ? $_SESSION['vd']['users_page_limit'] : 10; ?>">
			  <span class="add-on">
